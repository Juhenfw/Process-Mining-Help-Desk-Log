"""
Process Mining for Paper: FIXED VERSION (PM4Py Compatible)
- Multi-algorithm discovery (Inductive, Heuristics, Alpha)
            ...
            try:
                ...
                if isinstance(replay_result, dict):
                    fitness = replay_result.get('average_trace_fitness', 
                              replay_result.get('log_fitness', 0))
                else:
                    fitness = replay_result
